...
.defines( function(){
    ...
    Lizardhadoken = DeferredUpdate.extend({
        ...
        updateEntity : function( entity ){
            ...
            if( entity.currentAnim.stopped ){
                ...
                ig.game.spawnEntity( Attackhadoken, hadokenX, entity.pos.y + 60 ).getDirection( entity );
            }
        },
        ...
        awake : function( entity ){
            ...
            ig.game.spawnEntity( Effecthadoken, entity.pos.x, entity.pos.y ).registerOwner( entity );
            entity.toBack();
        }
    });
});
