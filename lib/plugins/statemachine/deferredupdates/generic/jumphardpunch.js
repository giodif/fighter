...
.defines( function(){
    ...
    Jumphardpunch = DeferredUpdate.extend({
        ...
        updateEntity : function( entity ){
            ...
            if( entity.currentAnim.stopped || entity.standing ){
                ...
                this.attack         = ig.game.spawnEntity( SimpleAttack, 0, 0, { size : { x : 25, y : 35 }, strength : 60 } );
        ...
        awake : function( entity ){
            ...
            entity.currentAnim          = entity.anims.jumphardpunch.rewind();
